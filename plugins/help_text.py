...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="💠 JOIN OUR CHANNEL 💠", url="https://t.me/RorschachMovies")]]),
        parse_mode="html",
...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ CHANNEL ⭕️", url="https://t.me/RorschachMovies")], [InlineKeyboardButton(text="😉 SUPPORT", url="https://t.me/filimsmovie"),
